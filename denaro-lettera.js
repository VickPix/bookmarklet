...
chart = new SmoothieChart({maxValueScale:.8,minValueScale:.8,millisPerPixel:500,grid:{millisPerLine:5000,verticalSections:5,strokeStyle:'rgba(119,119,119,0.61)'},labels:{disabled:true}});
